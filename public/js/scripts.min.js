function initMap() {
    ...
    S.fn = S.prototype = {
        ...
        var t, e, n, i, r, o, s = arguments[0] || {},
            ...
            u = arguments.length,
            l = !1;
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || S.isFunction(s) || (s = {}), a === u && (s = this, a--); a < u; a++)
            if (null != (t = arguments[a]))
                for (e in t) n = s[e], s !== (i = t[e]) && (l && i && (S.isPlainObject(i) || (r = Array.isArray(i))) ? (o = r ? (r = !1, n && Array.isArray(n) ? n : []) : n && S.isPlainObject(n) ? n : {}, s[e] = S.extend(l, o, i)) : void 0 !== i && (s[e] = i));
        return s
    }, S.extend({
        ...
        isPlainObject: function (t) {
            var e, n;
            return !(!t || "[object Object]" !== o.call(t) || (e = i(t)) && ("function" != typeof (n = p.call(e, "constructor") && e.constructor) || s.call(n) !== l))
        },
        ...
        makeArray: function (t, e) {
            var n = e || [];
            return null != t && (b(Object(t)) ? S.merge(n, "string" == typeof t ? [t] : t) : u.call(n, t)), n
        },
        ...
        proxy: function (t, e) {
            var n, i, r;
            if ("string" == typeof e && (n = t[e], e = t, t = n), S.isFunction(t)) return i = a.call(arguments, 2), (r = function () {
    ...
    var x = function (n) {
        var t, h, x, o, r, p, f, m, w, u, l, C, E, s, T, g, a, c, v, S = "sizzle" + 1 * new Date,
            y = n.document,
            k = 0,
            i = 0,
            d = st(),
        ...
        function ot(t, e, n, i) {
            var r, o, s, a, u, l, c, f = e && e.ownerDocument,
                d = e ? e.nodeType : 9;
            if (n = n || [], "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d) return n;
            if (!i && ((e ? e.ownerDocument || e : y) !== E && C(e), e = e || E, T)) {
                if (11 !== d && (u = Z.exec(t)))
                    if (r = u[1]) {
                        if (9 === d) {
                        ...
                        if ((r = u[3]) && h.getElementsByClassName && e.getElementsByClassName) return I.apply(n, e.getElementsByClassName(r)), n
                    } if (h.qsa && !_[t + " "] && (!g || !g.test(t))) {
                    if (1 !== d) f = e, c = t;
                    else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(et, nt) : e.setAttribute("id", a = S), o = (l = p(t)).length; o--;) l[o] = "#" + a + " " + vt(l[o]);
        ...
        for (t in h = ot.support = {}, r = ot.isXML = function (t) {
                var e = t && (t.ownerDocument || t).documentElement;
                return !!e && "HTML" !== e.nodeName
            }, C = ot.setDocument = function (t) {
                var e, n, i = t ? t.ownerDocument || t : y;
                return i !== E && 9 === i.nodeType && i.documentElement && (s = (E = i).documentElement, T = !r(E), y !== E && (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", it, !1) : n.attachEvent && n.attachEvent("onunload", it)), h.attributes = ut(function (t) {
                    return t.className = "i", !t.getAttribute("className")
                }), h.getElementsByTagName = ut(function (t) {
                    return t.appendChild(E.createComment("")), !t.getElementsByTagName("*").length
                }), h.getElementsByClassName = Q.test(E.getElementsByClassName), h.getById = ut(function (t) {
                    return s.appendChild(t).id = S, !E.getElementsByName || !E.getElementsByName(S).length
                }), h.getById ? (x.filter.ID = function (t) {
                ...
                }, a = [], g = [], (h.qsa = Q.test(E.querySelectorAll)) && (ut(function (t) {
                ...
                })), (h.matchesSelector = Q.test(c = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)) && ut(function (t) {
                    h.disconnectedMatch = c.call(t, "*"), c.call(t, "[s!='']:x"), a.push("!=", F)
                }), g = g.length && new RegExp(g.join("|")), a = a.length && new RegExp(a.join("|")), e = Q.test(s.compareDocumentPosition), v = e || Q.test(s.contains) ? function (t, e) {
                    ...
                    return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !h.sortDetached && e.compareDocumentPosition(t) === n ? t === E || t.ownerDocument === y && v(y, t) ? -1 : e === E || e.ownerDocument === y && v(y, e) ? 1 : u ? M(u, t) - M(u, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e) return l = !0, 0;
                    var n, i = 0,
                        r = t.parentNode,
                        ...
                        s = [t],
                        a = [e];
                    if (!r || !o) return t === E ? -1 : e === E ? 1 : r ? -1 : o ? 1 : u ? M(u, t) - M(u, e) : 0;
                ...
                if ((t.ownerDocument || t) !== E && C(t), e = e.replace($, "='$1']"), h.matchesSelector && T && !_[e + " "] && (!a || !a.test(e)) && (!g || !g.test(e))) try {
                    var n = c.call(t, e);
                ...
                preFilter: {
                    ...
                    PSEUDO: function (t) {
                        var e, n = !t[6] && t[2];
                        return U.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && Y.test(n) && (e = p(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (t) {
                    ...
                    CHILD: function (p, t, e, m, g) {
                        ...
                        return 1 === m && 0 === g ? function (t) {
                            ...
                            var i, r, o, s, a, u, l = v !== y ? "nextSibling" : "previousSibling",
                                c = t.parentNode,
                            ...
                            if (c) {
                                ...
                                if (u = [y ? c.firstChild : c.lastChild], y && d) {
                                    for (h = (a = (i = (r = (o = (s = c)[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === k && i[1]) && i[2], s = a && c.childNodes[a]; s = ++a && s && s[l] || (h = a = 0) || u.pop();)
                                        if (1 === s.nodeType && ++h && s === t) {
                                            r[p] = [k, a, h];
                                            break
                                        }
                                } else if (d && (h = a = (i = (r = (o = (s = t)[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === k && i[1]), !1 === h)
                                    for (;
                                        (s = ++a && s && s[l] || (h = a = 0) || u.pop()) && ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++h || (d && ((r = (o = s[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [k, h]), s !== t)););
                ...
                pseudos: {
                    ...
                    lang: at(function (n) {
                        return X.test(n || "") || ot.error("unsupported lang: " + n), n = n.replace(J, tt).toLowerCase(),
                            function (t) {
                                var e;
                                do {
        ...
        function yt(a, t, e) {
            ...
            return t.first ? function (t, e, n) {
                ...
                if (n) {
                    ...
                    for (; t = t[u];)
                        if (1 === t.nodeType || f)
                            if (r = (o = t[S] || (t[S] = {}))[t.uniqueID] || (o[t.uniqueID] = {}), l && l === t.nodeName.toLowerCase()) t = t[u] || t;
                            else {
                                if ((i = r[c]) && i[0] === k && i[1] === d) return s[2] = i[2];
        ...
        function wt(h, p, m, g, v, t) {
            return g && !g[S] && (g = wt(g)), v && !v[S] && (v = wt(v, t)), at(function (t, e, n, i) {
                var r, o, s, a = [],
                    u = [],
                    l = e.length,
                    c = t || function (t, e, n) {
                    ...
                    d = m ? v || (t ? h : l || g) ? [] : e : f;
                if (m && m(f, d, n, i), g)
                    for (r = xt(d, u), g(r, [], n, i), o = r.length; o--;)(s = r[o]) && (d[u[o]] = !(f[u[o]] = s));
                if (t) {
                    if (v || h) {
                        if (v) {
                        ...
                        for (o = d.length; o--;)(s = d[o]) && -1 < (r = v ? M(t, s) : a[o]) && (t[r] = !(e[r] = s))
                    }
        ...
        function Ct(t) {
            for (var r, e, n, i = t.length, o = x.relative[t[0].type], s = o || x.relative[" "], a = o ? 1 : 0, u = yt(function (t) {
                    return t === r
                }, s, !0), l = yt(function (t) {
                    return -1 < M(r, t)
                }, s, !0), c = [function (t, e, n) {
                    var i = !o && (n || e !== w) || ((r = e).nodeType ? u(t, e, n) : l(t, e, n));
                    return r = null, i
                }]; a < i; a++)
                if (e = x.relative[t[a].type]) c = [yt(bt(c), e)];
                    ...
                    if ((e = x.filter[t[a].type].apply(null, t[a].matches))[S]) {
                        ...
                        return wt(1 < a && bt(c), 1 < a && vt(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(H, "$1"), e, a < n && Ct(t.slice(a, n)), n < i && Ct(t = t.slice(n)), n < i && vt(t))
                    }
                    c.push(e)
                } return bt(c)
        }
        return gt.prototype = x.filters = x.pseudos, x.setFilters = new gt, p = ot.tokenize = function (t, e) {
            var n, i, r, o, s, a, u, l = b[t + " "];
            if (l) return e ? 0 : l.slice(0);
            for (s = t, a = [], u = x.preFilter; s;) {
                for (o in n && !(i = B.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(r = [])), n = !1, (i = W.exec(s)) && (n = i.shift(), r.push({
                        value: n,
                        type: i[0].replace(H, " ")
                    }), s = s.slice(n.length)), x.filter) !(i = U[o].exec(s)) || u[o] && !(i = u[o](i)) || (n = i.shift(), r.push({
                    value: n,
                    type: o,
                    matches: i
                }), s = s.slice(n.length));
            ...
            var n, g, v, y, b, i, r = [],
                ...
                s = _[t + " "];
            if (!s) {
                for (e || (e = p(t)), n = e.length; n--;)(s = Ct(e[n]))[S] ? r.push(s) : o.push(s);
                (s = _(t, (g = o, y = 0 < (v = r).length, b = 0 < g.length, i = function (t, e, n, i, r) {
                    var o, s, a, u = 0,
                        l = "0",
                        c = t && [],
                        f = [],
                        ...
                        m = h.length;
                    for (r && (w = e === E || e || r); l !== m && null != (o = h[l]); l++) {
                        if (b && o) {
                            for (s = 0, e || o.ownerDocument === E || (C(o), n = !T); a = g[s++];)
                                if (a(o, e || E, n)) {
                                    i.push(o);
                                    break
                                } r && (k = p)
                    ...
                    if (u += l, y && l !== u) {
                        ...
                        if (t) {
                            if (0 < u)
                                for (; l--;) c[l] || f[l] || (f[l] = L.call(i));
                            f = xt(f)
                        }
                        I.apply(i, f), r && !t && 0 < f.length && 1 < u + v.length && ot.uniqueSort(i)
                    }
                    return r && (k = p, w = d), c
                }, y ? at(i) : i))).selector = t
            }
            ...
            if (n = n || [], 1 === c.length) {
                if (2 < (o = c[0] = c[0].slice(0)).length && "ID" === (s = o[0]).type && 9 === e.nodeType && T && x.relative[o[1].type]) {
                    if (!(e = (x.find.ID(s.matches[0].replace(J, tt), e) || [])[0])) return n;
                    l && (e = e.parentNode), t = t.slice(o.shift().value.length)
                }
                for (r = U.needsContext.test(t) ? 0 : o.length; r-- && (s = o[r], !x.relative[a = s.type]);)
                    if ((u = x.find[a]) && (i = u(s.matches[0].replace(J, tt), K.test(o[0].type) && mt(e.parentNode) || e))) {
                        if (o.splice(r, 1), !(t = i.length && vt(o))) return I.apply(n, i), n;
                        break
                    }
            }
            return (l || f(t, c))(i, e, !T, n, !e || K.test(t) && mt(e.parentNode) || e), n
        }, h.sortStable = S.split("").sort(O).join("") === S, h.detectDuplicates = !!l, C(), h.sortDetached = ut(function (t) {
    ...
    function L(t, n, i) {
        ...
        }) : A.test(n) ? S.filter(n, t, i) : (n = S.filter(n, t), S.grep(t, function (t) {
    ...
    (S.fn.init = function (t, e, n) {
        var i, r;
        if (!t) return this;
        if (n = n || j, "string" != typeof t) return t.nodeType ? (this[0] = t, this.length = 1, this) : S.isFunction(t) ? void 0 !== n.ready ? n.ready(t) : t(S) : S.makeArray(t, this);
        if (!(i = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : I.exec(t)) || !i[1] && e) return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
        if (i[1]) {
            if (e = e instanceof S ? e[0] : e, S.merge(this, S.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : T, !0)), O.test(i[1]) && S.isPlainObject(e))
                for (i in e) S.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
            return this
        }
        return (r = T.getElementById(i[2])) && (this[0] = r, this.length = 1), this
    }).prototype = S.fn, j = S(T);
    ...
    S.fn.extend({
        ...
        contents: function (t) {
            return _(t, "iframe") ? t.contentDocument : (_(t, "template") && (t = t.content || t), S.merge([], t.childNodes))
        }
    }, function (i, r) {
        S.fn[i] = function (t, e) {
            var n = S.map(this, r, t);
            return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = S.filter(e, n)), 1 < this.length && (M[i] || S.uniqueSort(n), N.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var z = /[^\x20\t\r\n\f]+/g;
    ...
    function F(t, e, n, i) {
        var r;
        try {
            t && S.isFunction(r = t.promise) ? r.call(t).done(e).fail(n) : t && S.isFunction(r = t.then) ? r.call(t, e, n) : e.apply(void 0, [t].slice(i))
        } catch (t) {
            n.apply(void 0, [t])
        }
    }
    S.Callbacks = function (i) {
        var t, n;
        i = "string" == typeof i ? (t = i, n = {}, S.each(t.match(z) || [], function (t, e) {
            n[e] = !0
        }), n) : S.extend({}, i);
        var r, e, o, s, a = [],
            u = [],
            ...
            c = function () {
                for (s = s || i.once, o = r = !0; u.length; l = -1)
                    for (e = u.shift(); ++l < a.length;) !1 === a[l].apply(e[0], e[1]) && i.stopOnFalse && (l = a.length, e = !1);
                i.memory || (e = !1), r = !1, s && (a = e ? [] : "")
            },
            f = {
                add: function () {
                    return a && (e && !r && (l = a.length - 1, u.push(e)), function n(t) {
                        S.each(t, function (t, e) {
                            S.isFunction(e) ? i.unique && f.has(e) || a.push(e) : e && e.length && "string" !== S.type(e) && n(e)
                        })
                    }(arguments), e && !r && c()), this
                },
                remove: function () {
                    return S.each(arguments, function (t, e) {
                        for (var n; - 1 < (n = S.inArray(e, a, n));) a.splice(n, 1), n <= l && l--
                    }), this
                },
                has: function (t) {
                ...
                s = {
                    ...
                    then: function (e, n, i) {
                                ...
                                var n = this,
                                    ...
                                    t = function () {
                                        ...
                                        if (!(r < u)) {
                                            ...
                                            e = t && ("object" == typeof t || "function" == typeof t) && t.then, S.isFunction(e) ? a ? e.call(t, l(u, o, P, a), l(u, o, q, a)) : (u++, e.call(t, l(u, o, P, a), l(u, o, q, a), l(u, o, P, o.notifyWith))) : (s !== P && (n = void 0, i = [t]), (a || o.resolveWith)(n, i))
                                        }
                                    },
                                    e = a ? t : function () {
                                        try {
                                            ...
                                            S.Deferred.exceptionHook && S.Deferred.exceptionHook(t, e.stackTrace), u <= r + 1 && (s !== q && (n = void 0, i = [t]), o.rejectWith(n, i))
                                        }
                                    };
                        ...
                        return S.Deferred(function (t) {
                            o[0][3].add(l(0, t, S.isFunction(i) ? i : P, t.notifyWith)), o[1][3].add(l(0, t, S.isFunction(e) ? e : P)), o[2][3].add(l(0, t, S.isFunction(n) ? n : q))
                        }).promise()
                    },
                    promise: function (t) {
        ...
        when: function (t) {
            ...
            if (n <= 1 && (F(t, o.done(s(e)).resolve, o.reject, !n), "pending" === o.state() || S.isFunction(r[e] && r[e].then))) return o.then();
    ...
    S.Deferred.exceptionHook = function (t, e) {
        E.console && E.console.warn && t && R.test(t.name) && E.console.warn("jQuery.Deferred exception: " + t.message, t.stack, e)
    ...
    function B() {
        T.removeEventListener("DOMContentLoaded", B), E.removeEventListener("load", B), S.ready()
    }
    ...
    }), S.ready.then = H.then, "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? E.setTimeout(S.ready) : (T.addEventListener("DOMContentLoaded", B), E.addEventListener("load", B));
    var W = function (t, e, n, i, r, o, s) {
            ...
            else if (void 0 !== i && (r = !0, S.isFunction(i) || (s = !0), l && (e = s ? (e.call(t, i), null) : (l = e, function (t, e, n) {
                    return l.call(S(t), n)
                })), e))
    ...
    Y.uid = 1, Y.prototype = {
        ...
        set: function (t, e, n) {
            ...
            if ("string" == typeof e) r[S.camelCase(e)] = n;
                ...
                for (i in e) r[S.camelCase(i)] = e[i];
            return r
        },
        get: function (t, e) {
        ...
        remove: function (t, e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== e) {
                    n = (e = Array.isArray(e) ? e.map(S.camelCase) : (e = S.camelCase(e)) in i ? [e] : e.match(z) || []).length;
                    for (; n--;) delete i[e[n]]
    ...
    S.extend({
        ...
        data: function (n, t) {
            ...
            if (this.length && (r = U.get(o), 1 === o.nodeType && !X.get(o, "hasDataAttrs"))) {
                for (e = s.length; e--;) s[e] && (0 === (i = s[e].name).indexOf("data-") && (i = S.camelCase(i.slice(5)), Q(o, i, r[i])));
        ...
        queue: function (t, e, n) {
            var i;
            if (t) return e = (e || "fx") + "queue", i = X.get(t, e), n && (!i || Array.isArray(n) ? i = X.access(t, e, S.makeArray(n)) : i.push(n)), i || []
        },
    ...
    function lt(t, e) {
        var n;
        return n = void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e || "*") : void 0 !== t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && _(t, e) ? S.merge([t], n) : n
    }
    ...
    function pt(t, e, n, i, r) {
        for (var o, s, a, u, l, c, f = e.createDocumentFragment(), d = [], h = 0, p = t.length; h < p; h++)
            ...
            for (s = s || f.appendChild(e.createElement("div")), a = (st.exec(o) || ["", ""])[1].toLowerCase(), u = ut[a] || ut._default, s.innerHTML = u[1] + S.htmlPrefilter(o) + u[2], c = u[0]; c--;) s = s.lastChild;
            S.merge(d, s.childNodes), (s = f.firstChild).textContent = ""
        } else d.push(e.createTextNode(o));
        for (f.textContent = "", h = 0; o = d[h++];)
            if (i && -1 < S.inArray(o, i)) r && r.push(o);
            else if (l = S.contains(o.ownerDocument, o), s = lt(f.appendChild(o), "script"), l && ct(s), n)
    ...
    S.event = {
        ...
        add: function (e, t, n, i, r) {
            var o, s, a, u, l, c, f, d, h, p, m, g = X.get(e);
            if (g)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && S.find.matchesSelector(mt, r), n.guid || (n.guid = S.guid++), (u = g.events) || (u = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
                        return void 0 !== S && S.event.triggered !== t.type ? S.event.dispatch.apply(e, arguments) : void 0
                    }), l = (t = (t || "").match(z) || [""]).length; l--;) h = m = (a = yt.exec(t[l]) || [])[1], p = (a[2] || "").split(".").sort(), h && (f = S.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = S.event.special[h] || {}, c = S.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: p.join(".")
                }, o), (d = u[h]) || ((d = u[h] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(h, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, c) : d.push(c), S.event.global[h] = !0)
        },
        remove: function (t, e, n, i, r) {
            var o, s, a, u, l, c, f, d, h, p, m, g = X.hasData(t) && X.get(t);
            if (g && (u = g.events)) {
                for (l = (e = (e || "").match(z) || [""]).length; l--;)
                    if (h = m = (a = yt.exec(e[l]) || [])[1], p = (a[2] || "").split(".").sort(), h) {
                        for (f = S.event.special[h] || {}, d = u[h = (i ? f.delegateType : f.bindType) || h] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) c = d[o], !r && m !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(t, c));
                        s && !d.length && (f.teardown && !1 !== f.teardown.call(t, p, g.handle) || S.removeEvent(t, h, g.handle), delete u[h])
                    } else
                        for (h in u) S.event.remove(t, h + e[l], n, i, !0);
            ...
            if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                for (s = S.event.handlers.call(this, a, l), e = 0;
                    ...
                    for (a.currentTarget = r.elem, n = 0;
                        (o = r.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, a.data = o.data, void 0 !== (i = ((S.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, u)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
            ...
            if (u && l.nodeType && !("click" === t.type && 1 <= t.button))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== t.type || !0 !== l.disabled)) {
                        for (o = [], s = {}, n = 0; n < u; n++) void 0 === s[r = (i = e[n]).selector + " "] && (s[r] = i.needsContext ? -1 < S(r, this).index(l) : S.find(r, this, null, [l]).length), s[r] && o.push(i);
                        o.length && a.push({
                            elem: l,
                            handlers: o
                        })
        ...
        return this instanceof S.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? bt : xt, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t, e && S.extend(this, e), this.timeStamp = t && t.timeStamp || S.now(), void(this[S.expando] = !0)) : new S.Event(t, e)
    }, S.Event.prototype = {
        constructor: S.Event,
    ...
    function Ot(t, e) {
        return _(t, "table") && _(11 !== e.nodeType ? e : e.firstChild, "tr") && S(">tbody", t)[0] || t
    }
    ...
    function jt(t, e) {
        var n, i, r, o, s, a, u, l;
        if (1 === e.nodeType) {
            if (X.hasData(t) && (o = X.access(t), s = X.set(e, o), l = o.events))
    ...
    function It(n, i, r, o) {
        ...
        var t, e, s, a, u, l, c = 0,
            ...
            h = i[0],
            p = S.isFunction(h);
        if (p || 1 < f && "string" == typeof h && !g.checkClone && St.test(h)) return n.each(function (t) {
            var e = n.eq(t);
            p && (i[0] = h.call(this, t, e.html())), It(e, i, r, o)
        });
        if (f && (e = (t = pt(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === t.childNodes.length && (t = e), e || o)) {
            for (a = (s = S.map(lt(t, "script"), At)).length; c < f; c++) u = t, c !== d && (u = S.clone(u, !0, !0), a && S.merge(s, lt(u, "script"))), r.call(n[c], u, c);
            if (a)
                for (l = s[s.length - 1].ownerDocument, S.map(s, Lt), c = 0; c < a; c++) u = s[c], at.test(u.type || "") && !X.access(u, "globalEval") && S.contains(l, u) && (u.src ? S._evalUrl && S._evalUrl(u.src) : v(u.textContent.replace(_t, ""), l))
        }
        return n
    }

    function Nt(t, e, n) {
        for (var i, r = e ? S.filter(e, t) : t, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || S.cleanData(lt(i)), i.parentNode && (n && S.contains(i.ownerDocument, i) && ct(lt(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    S.extend({
        ...
        clone: function (t, e, n) {
            ...
            if (!(g.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || S.isXMLDoc(t)))
                for (s = lt(c), i = 0, r = (o = lt(t)).length; i < r; i++) a = o[i], u = s[i], void 0, "input" === (l = u.nodeName.toLowerCase()) && ot.test(a.type) ? u.checked = a.checked : "input" !== l && "textarea" !== l || (u.defaultValue = a.defaultValue);
            if (e)
                if (n)
                    for (o = o || lt(t), s = s || lt(c), i = 0, r = o.length; i < r; i++) jt(o[i], s[i]);
                else jt(t, c);
            return 0 < (s = lt(c, "script")).length && ct(s, !f && lt(t, "script")), c
        },
        ...
        html: function (t) {
            return W(this, function (t) {
                ...
                if ("string" == typeof t && !Tt.test(t) && !ut[(st.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = S.htmlPrefilter(t);
                    try {
        ...
        S.fn[t] = function (t) {
            for (var e, n = [], i = S(t), r = i.length - 1, o = 0; o <= r; o++) e = o === r ? this : this.clone(!0), S(i[o])[s](e), u.apply(n, e.get());
    ...
    function Pt(t, e, n) {
        ...
        return (n = n || zt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || S.contains(t.ownerDocument, t) || (s = S.style(t, e)), !g.pixelMarginRight() && Dt.test(s) && Mt.test(e) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function qt(t, e) {
        ...
        function t() {
            if (s) {
                s.style.cssText = "box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", s.innerHTML = "", mt.appendChild(o);
                var t = E.getComputedStyle(s);
                e = "1%" !== t.top, r = "2px" === t.marginLeft, n = "4px" === t.width, s.style.marginRight = "50%", i = "4px" === t.marginRight, mt.removeChild(o), s = null
            }
        }
        var e, n, i, r, o = T.createElement("div"),
            s = T.createElement("div");
        s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", g.clearCloneStyle = "content-box" === s.style.backgroundClip, o.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", o.appendChild(s), S.extend(g, {
    ...
    function Ut(t, e, n, i, r) {
        var o, s = 0;
        for (o = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2) "margin" === n && (s += S.css(t, n + J[o], !0, r)), i ? ("content" === n && (s -= S.css(t, "padding" + J[o], !0, r)), "margin" !== n && (s -= S.css(t, "border" + J[o] + "Width", !0, r))) : (s += S.css(t, "padding" + J[o], !0, r), "padding" !== n && (s += S.css(t, "border" + J[o] + "Width", !0, r)));
        return s
    }
    ...
    function Vt(t, e, n) {
        ...
        return Dt.test(o) ? o : (i = s && (g.boxSizingReliable() || o === t.style[e]), "auto" === o && (o = t["offset" + e[0].toUpperCase() + e.slice(1)]), (o = parseFloat(o) || 0) + Ut(t, e, n || (s ? "border" : "content"), i, r) + "px")
    }
    ...
    S.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, o, s, a = S.camelCase(e),
                    u = Rt.test(e),
                    l = t.style;
                return u || (e = Yt(a)), s = S.cssHooks[e] || S.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(t, !1, i)) ? r : l[e] : ("string" === (o = typeof n) && (r = K.exec(n)) && r[1] && (n = nt(t, e, r), o = "number"), void(null != n && n == n && ("number" === o && (n += r && r[3] || (S.cssNumber[a] ? "" : "px")), g.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (u ? l.setProperty(e, n) : l[e] = n))))
            }
        },
        css: function (t, e, n, i) {
            var r, o, s, a = S.camelCase(e);
            return Rt.test(e) || (e = Yt(a)), (s = S.cssHooks[e] || S.cssHooks[a]) && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = Pt(t, e, i)), "normal" === r && e in Bt && (r = Bt[e]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), S.each(["height", "width"], function (t, s) {
        S.cssHooks[s] = {
            get: function (t, e, n) {
                if (e) return !Ft.test(S.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Vt(t, s, n) : et(t, Ht, function () {
                    return Vt(t, s, n)
                })
            },
            set: function (t, e, n) {
                var i, r = n && zt(t),
                    o = n && Ut(t, s, n, "border-box" === S.css(t, "boxSizing", !1, r), r);
                return o && (i = K.exec(e)) && "px" !== (i[3] || "px") && (t.style[s] = e, e = S.css(t, s)), Xt(0, e, o)
            }
        }
    }), S.cssHooks.marginLeft = qt(g.reliableMarginLeft, function (t, e) {
        if (e) return (parseFloat(Pt(t, "marginLeft")) || t.getBoundingClientRect().left - et(t, {
            marginLeft: 0
        }, function () {
        ...
        S.cssHooks[r + o] = {
            expand: function (t) {
                for (var e = 0, n = {}, i = "string" == typeof t ? t.split(" ") : [t]; e < 4; e++) n[r + J[e] + o] = i[e] || i[e - 2] || i[0];
                return n
            }
        ...
        run: function (t) {
            ...
            return this.options.duration ? this.pos = e = S.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Gt.propHooks._default.set(this), this
        }
        ...
        _default: "swing"
    }, S.fx = Gt.prototype.init, S.fx.step = {};
    var Qt, Zt, Kt, Jt, te = /^(?:toggle|show|hide)$/,
        ee = /queueHooks$/;

    function ne() {
        Zt && (!1 === T.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(ne) : E.setTimeout(ne, S.fx.interval), S.fx.tick())
    }
    ...
    function se(o, t, e) {
        var n, s, i = 0,
            ...
            u = function () {
                if (s) return !1;
                for (var t = Qt || ie(), e = Math.max(0, l.startTime + l.duration - t), n = 1 - (e / l.duration || 0), i = 0, r = l.tweens.length; i < r; i++) l.tweens[i].run(n);
        ...
        for (function (t, e) {
                var n, i, r, o, s;
                for (n in t)
                    if (r = e[i = S.camelCase(n)], o = t[n], Array.isArray(o) && (r = o[1], o = t[n] = o[0]), n !== i && (t[i] = o, delete t[n]), (s = S.cssHooks[i]) && "expand" in s)
                        for (n in o = s.expand(o), delete t[i], o) n in t || (t[n] = o[n], e[n] = r);
                    else e[i] = r
            }(c, l.opts.specialEasing); i < r; i++)
            if (n = se.prefilters[i].call(l, o, c, l.opts)) return S.isFunction(n.stop) && (S._queueHooks(l.elem, l.opts.queue).stop = S.proxy(n.stop, n)), n;
        return S.map(c, oe, l), S.isFunction(l.opts.start) && l.opts.start.call(o, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), S.fx.timer(S.extend(u, {
            elem: o,
            anim: l,
            queue: l.opts.queue
        })), l
    ...
    S.Animation = S.extend(se, {
        ...
        tweener: function (t, e) {
            for (var n, i = 0, r = (t = S.isFunction(t) ? (e = t, ["*"]) : t.match(z)).length; i < r; i++) n = t[i], se.tweeners[n] = se.tweeners[n] || [], se.tweeners[n].unshift(e)
        },
        prefilters: [function (t, e, n) {
            ...
            for (i in n.queue || (null == (s = S._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in f && 1 === t.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (l = g && g.display) && (l = X.get(t, "display")), "none" === (c = S.css(t, "display")) && (l ? c = l : (rt([t], !0), l = t.style.display || l, c = S.css(t, "display"), rt([t]))), ("inline" === c || "inline-block" === c && null != l) && "none" === S.css(t, "float") && (u || (d.done(function () {
                        p.display = l
                    }), null == l && (c = p.display, l = "none" === c ? "" : c)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function () {
                        p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
                    })), u = !1, h) u || (g ? "hidden" in g && (m = g.hidden) : g = X.access(t, "fxshow", {
                    display: l
                }), o && (g.hidden = !m), m && rt([t], !0), d.done(function () {
                    for (i in m || rt([t]), X.remove(t, "fxshow"), h) S.style(t, i, h[i])
        ...
        stop: function (r, t, o) {
            ...
            return "string" != typeof r && (o = t, t = r, r = void 0), t && !1 !== r && this.queue(r || "fx", []), this.each(function () {
                ...
                if (e) i[e] && i[e].stop && s(i[e]);
                    ...
                    for (e in i) i[e] && i[e].stop && ee.test(e) && s(i[e]);
        ...
        S.fn[i] = function (t, e, n) {
            return null == t || "boolean" == typeof t ? r.apply(this, arguments) : this.animate(re(i, !0), t, e, n)
        }
    }), S.each({
        slideDown: re("show"),
        slideUp: re("hide"),
        ...
        var t, e = 0,
            n = S.timers;
        for (Qt = S.now(); e < n.length; e++)(t = n[e])() || n[e] !== t || n.splice(e--, 1);
    ...
    S.fn.extend({
        ...
        attr: function (t, e, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === t.getAttribute ? S.prop(t, e, n) : (1 === o && S.isXMLDoc(t) || (r = S.attrHooks[e.toLowerCase()] || (S.expr.match.bool.test(e) ? ae : void 0)), void 0 !== n ? null === n ? void S.removeAttr(t, e) : r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : r && "get" in r && null !== (i = r.get(t, e)) ? i : null == (i = S.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (t, e) {
        ...
        ue[e] = function (t, e, n) {
            ...
            return n || (r = ue[o], ue[o] = i, i = null != s(t, e, n) ? o : null, ue[o] = r), i
        }
    });
    ...
    S.fn.extend({
        ...
        toggleClass: function (r, e) {
            ...
            return "boolean" == typeof e && "string" === o ? e ? this.addClass(r) : this.removeClass(r) : S.isFunction(r) ? this.each(function (t) {
                ...
                var t, e, n, i;
                if ("string" === o)
                    for (e = 0, n = S(this), i = r.match(z) || []; t = i[e++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
                else void 0 !== r && "boolean" !== o || ((t = de(this)) && X.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === r ? "" : X.get(this, "__className__") || ""))
            })
        },
        hasClass: function (t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + fe(de(n)) + " ").indexOf(e)) return !0;
            return !1
        }
    });
    var he = /\r/g;
    S.fn.extend({
        val: function (n) {
            ...
            })) : e ? (i = S.valHooks[e.type] || S.valHooks[e.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(e, "value")) ? t : "string" == typeof (t = e.value) ? t.replace(he, "") : null == t ? "" : t : void 0
        }
    }), S.extend({
        valHooks: {
            option: {
        ...
        trigger: function (t, e, n, i) {
            ...
            if (o = s = n = n || T, 3 !== n.nodeType && 8 !== n.nodeType && !pe.test(d + S.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, (t = t[S.expando] ? t : new S.Event(d, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : S.makeArray(e, [t]), c = S.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, e))) {
                if (!i && !c.noBubble && !S.isWindow(n)) {
                    for (a = c.delegateType || d, pe.test(a + d) || (o = o.parentNode); o; o = o.parentNode) f.push(o), s = o;
                    s === (n.ownerDocument || T) && f.push(s.defaultView || s.parentWindow || E)
                }
                for (r = 0;
                    (o = f[r++]) && !t.isPropagationStopped();) t.type = 1 < r ? a : c.bindType || d, (l = (X.get(o, "events") || {})[t.type] && X.get(o, "handle")) && l.apply(o, e), (l = u && o[u]) && l.apply && $(o) && (t.result = l.apply(o, e), !1 === t.result && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(f.pop(), e) || !$(n) || u && S.isFunction(n[d]) && !S.isWindow(n) && ((s = n[u]) && (n[u] = null), n[S.event.triggered = d](), S.event.triggered = void 0, s && (n[u] = s)), t.result
            }
        },
    ...
    }), g.focusin = "onfocusin" in E, g.focusin || S.each({
        focus: "focusin",
        blur: "focusout"
    }, function (n, i) {
        var r = function (t) {
    ...
    function Ce(n, t, i, r) {
        ...
        if (Array.isArray(t)) S.each(t, function (t, e) {
            i || ye.test(n) ? r(n, e) : Ce(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, r)
        });
        else if (i || "object" !== S.type(t)) r(n, t);
        else
            for (e in t) Ce(n + "[" + e + "]", t[e], i, r)
    }
    S.param = function (t, e) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !S(this).is(":disabled") && we.test(this.nodeName) && !xe.test(t) && (this.checked || !ot.test(t))
            }).map(function (t, e) {
                var n = S(this).val();
    ...
    Ie.href = me.href, S.extend({
        ...
        ajax: function (t, e) {
            ...
            var c, f, d, n, h, i, p, m, r, o, g = S.ajaxSetup({}, e),
                v = g.context || g,
            ...
            function l(t, e, n, i) {
                var r, o, s, a, u, l = e;
                p || (p = !0, h && E.clearTimeout(h), c = void 0, d = i || "", C.readyState = 0 < t ? 4 : 0, r = 200 <= t && t < 300 || 304 === t, n && (a = function (t, e, n) {
                ...
                }(g, a, C, r), r ? (g.ifModified && ((u = C.getResponseHeader("Last-Modified")) && (S.lastModified[f] = u), (u = C.getResponseHeader("etag")) && (S.etag[f] = u)), 204 === t || "HEAD" === g.type ? l = "nocontent" : 304 === t ? l = "notmodified" : (l = a.state, o = a.data, r = !(s = a.error))) : (s = l, !t && l || (l = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (e || l) + "", r ? b.resolveWith(v, [o, l, C]) : b.rejectWith(v, [C, l, s]), C.statusCode(w), w = void 0, m && y.trigger(r ? "ajaxSuccess" : "ajaxError", [C, g, r ? o : s]), x.fireWith(v, [C, l]), m && (y.trigger("ajaxComplete", [C, g]), --S.active || S.event.trigger("ajaxStop")))
            }
            return C
        },
    ...
    g.cors = !!Pe && "withCredentials" in Pe, g.ajax = Pe = !!Pe, S.ajaxTransport(function (r) {
        var o, s;
        if (g.cors || Pe && !r.crossDomain) return {
            send: function (t, e) {
                var n, i = r.xhr();
                ...
                o = function (t) {
                    return function () {
                        o && (o = s = i.onload = i.onerror = i.onabort = i.onreadystatechange = null, "abort" === t ? i.abort() : "error" === t ? "number" != typeof i.status ? e(0, "error") : e(i.status, i.statusText) : e(ze[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    S.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = S.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Re, "$1" + i) : !1 !== t.jsonp && (t.url += (ve.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            return o || S.error(i + " was not called"), o[0]
        }, t.dataTypes[0] = "json", r = E[i], E[i] = function () {
            o = arguments
        }, n.always(function () {
            void 0 === r ? S(E).removeProp(i) : E[i] = r, t[i] && (t.jsonpCallback = e.jsonpCallback, Fe.push(i)), o && S.isFunction(r) && r(o[0]), o = r = void 0
        }), "script"
    }), g.createHTMLDocument = ((qe = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === qe.childNodes.length), S.parseHTML = function (t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (g.createHTMLDocument ? ((i = (e = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href, e.head.appendChild(i)) : e = T), o = !n && [], (r = O.exec(t)) ? [e.createElement(r[1])] : (r = pt([t], e, o), o && o.length && S(o).remove(), S.merge([], r.childNodes)));
        var i, r, o
    }, S.fn.load = function (t, e, n) {
        var i, r, o, s = this,
            a = t.indexOf(" ");
        return -1 < a && (i = fe(t.slice(a)), t = t.slice(0, a)), S.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), 0 < s.length && S.ajax({
            url: t,
            type: r || "GET",
            dataType: "html",
            data: e
        ...
        setOffset: function (t, e, n) {
            var i, r, o, s, a, u, l = S.css(t, "position"),
                c = S(t),
                f = {};
            "static" === l && (t.style.position = "relative"), a = c.offset(), o = S.css(t, "top"), u = S.css(t, "left"), r = ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (s = (i = c.position()).top, i.left) : (s = parseFloat(o) || 0, parseFloat(u) || 0), S.isFunction(e) && (e = e.call(t, n, S.extend({}, a))), null != e.top && (f.top = e.top - a.top + s), null != e.left && (f.left = e.left - a.left + r), "using" in e ? e.using.call(t, f) : c.css(f)
        }
    }, S.fn.extend({
        offset: function (e) {
        ...
        position: function () {
            if (this[0]) {
                ...
                return "fixed" === S.css(n, "position") ? e = n.getBoundingClientRect() : (t = this.offsetParent(), e = this.offset(), _(t[0], "html") || (i = t.offset()), i = {
        ...
        S.fn[e] = function (t) {
            return W(this, function (t, e, n) {
                var i;
                return S.isWindow(t) ? i = t : 9 === t.nodeType && (i = t.defaultView), void 0 === n ? i ? i[r] : t[e] : void(i ? i.scrollTo(o ? i.pageXOffset : n, o ? n : i.pageYOffset) : t[e] = n)
            }, e, t, arguments.length)
        }
    }), S.each(["top", "left"], function (t, n) {
        S.cssHooks[n] = qt(g.pixelPosition, function (t, e) {
            if (e) return e = Pt(t, n), Dt.test(e) ? S(t).position()[n] + "px" : e
        })
    }), S.each({
        Height: "height",
        Width: "width"
        ...
        S.each({
            ...
            S.fn[o] = function (t, e) {
                ...
                return W(this, function (t, e, n) {
                    var i;
                    return S.isWindow(t) ? 0 === o.indexOf("outer") ? t["inner" + s] : t.document.documentElement["client" + s] : 9 === t.nodeType ? (i = t.documentElement, Math.max(t.body["scroll" + s], i["scroll" + s], t.body["offset" + s], i["offset" + s], i["client" + s])) : void 0 === n ? S.css(t, e, r) : S.style(t, e, n, r)
                }, a, n ? t : void 0, n)
            }
        })
    }), S.fn.extend({
    ...
    }, S.isArray = Array.isArray, S.parseJSON = JSON.parse, S.nodeName = _, "function" == typeof define && define.amd && define("jquery", [], function () {
        return S
    });
    var He = E.jQuery,
        Be = E.$;
    ...
    c.extend(c.fn, {
        validate: function (t) {
            if (this.length) {
                ...
                return i || (this.attr("novalidate", "novalidate"), i = new c.validator(t, this[0]), c.data(this[0], "validator", i), i.settings.onsubmit && (this.on("click.validate", ":submit", function (t) {
        ...
        rules: function (t, e) {
            ...
            if (null != u && (!u.form && u.hasAttribute("contenteditable") && (u.form = this.closest("form")[0], u.name = this.attr("name")), null != u.form)) {
                if (t) switch (i = (n = c.data(u.form, "validator").settings).rules, r = c.validator.staticRules(u), t) {
                    case "add":
                        c.extend(r, c.validator.normalizeRule(e)), delete r.messages, i[u.name] = r, e.messages && (n.messages[u.name] = c.extend(n.messages[u.name], e.messages));
                        break;
                    case "remove":
                ...
                return (o = c.validator.normalizeRules(c.extend({}, c.validator.classRules(u), c.validator.attributeRules(u), c.validator.dataRules(u), c.validator.staticRules(u)), u)).required && (s = o.required, delete o.required, o = c.extend({
                    required: s
        ...
        prototype: {
            ...
            element: function (t) {
                var e, n, i = this.clean(t),
                    ...
                    o = this,
                    s = !0;
                return void 0 === r ? delete this.invalid[i.name] : (this.prepareElement(r), this.currentElements = c(r), (n = this.groups[r.name]) && c.each(this.groups, function (t, e) {
                    e === n && t !== r.name && (i = o.validationTargetFor(o.clean(o.findByName(t)))) && i.name in o.invalid && (o.currentElements.push(i), s = o.check(i) && s)
            ...
            elements: function () {
                ...
                return c(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function () {
                    ...
                    return !t && e.settings.debug && window.console && console.error("%o has no name assigned", this), this.hasAttribute("contenteditable") && (this.form = c(this).closest("form")[0], this.name = t), !(t in n || !e.objectLength(c(this).rules())) && (n[t] = !0)
                })
            },
            clean: function (t) {
                return c(t)[0]
            ...
            elementValue: function (t) {
                var e, n, i = c(t),
                    r = t.type;
                return "radio" === r || "checkbox" === r ? this.findByName(t.name).filter(":checked").val() : "number" === r && void 0 !== t.validity ? t.validity.badInput ? "NaN" : i.val() : (e = t.hasAttribute("contenteditable") ? i.text() : i.val(), "file" === r ? "C:\\fakepath\\" === e.substr(0, 12) ? e.substr(12) : 0 <= (n = e.lastIndexOf("/")) ? e.substr(n + 1) : 0 <= (n = e.lastIndexOf("\\")) ? e.substr(n + 1) : e : "string" == typeof e ? e.replace(/\r/g, "") : e)
            },
            check: function (e) {
                e = this.validationTargetFor(this.clean(e));
                var t, n, i, r, o = c(e).rules(),
                ...
                if ("function" == typeof o.normalizer ? r = o.normalizer : "function" == typeof this.settings.normalizer && (r = this.settings.normalizer), r) {
                    if ("string" != typeof (u = r.call(e, u))) throw new TypeError("The normalizer should return a string value.");
                    delete o.normalizer
                }
                for (n in o) {
                    i = {
                    ...
                    try {
                        if ("dependency-mismatch" === (t = c.validator.methods[n].call(this, u, e, i.parameters)) && 1 === s) {
                            a = !0;
                            continue
                        }
            ...
            defaultMessage: function (t, e) {
                ...
                var n = this.findDefined(this.customMessage(t.name, e.method), this.customDataMessage(t, e.method), !this.settings.ignoreTitle && t.title || void 0, c.validator.messages[e.method], "<strong>Warning: No message defined for " + t.name + "</strong>"),
                    i = /\$?\{(\d+)\}/g;
        ...
        attributeRules: function (t) {
            ...
            for (e in c.validator.methods) n = "required" === e ? ("" === (n = t.getAttribute(e)) && (n = !0), !!n) : r.attr(e), this.normalizeAttributeRule(i, o, e, n);
        ...
        dataRules: function (t) {
            var e, n, i = {},
                r = c(t),
                o = t.getAttribute("type");
            for (e in c.validator.methods) n = r.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase()), this.normalizeAttributeRule(i, o, e, n);
            return i
        },
            ...
            return c.each(i, function (t, e) {
                if (!1 !== e) {
                    if (e.param || e.depends) {
                        ...
                        n ? i[t] = void 0 === e.param || e.param : (c.data(r.form, "validator").resetElements(c(r)), delete i[t])
                    }
                } else delete i[t]
        ...
        methods: {
            ...
            step: function (t, e, n) {
                ...
                return i = a(n), (a(t) > i || u(t) % u(n) != 0) && (l = !1), this.optional(e) || l
            },
            ...
            remote: function (o, s, t, a) {
                ...
                var u, e, n, l = this.previousValue(s, a);
                return this.settings.messages[s.name] || (this.settings.messages[s.name] = {}), l.originalMessage = l.originalMessage || this.settings.messages[s.name][a], this.settings.messages[s.name][a] = l.message, t = "string" == typeof t && {
                    url: t
                } || t, n = c.param(c.extend({
                    data: o
                }, t.data)), l.old === n ? l.valid : (l.old = n, (u = this).startRequest(s), (e = {})[s.name] = o, c.ajax(c.extend(!0, {
                    mode: "abort",
                    ...
                    success: function (t) {
                        ...
                        u.settings.messages[s.name][a] = l.originalMessage, r ? (i = u.formSubmitted, u.resetInternals(), u.toHide = u.errorsFor(s), u.formSubmitted = i, u.successList.push(s), u.invalid[s.name] = !1, u.showErrors()) : (e = {}, n = t || u.defaultMessage(s, {
                            method: a,
                            parameters: o
                        }), e[s.name] = l.message = n, u.invalid[s.name] = !0, u.showErrors(e)), l.valid = r, u.stopRequest(s, r)
                    }
                }, t)), "pending")
            }
        }
...
function (t) {
    ...
    var f, i, d, r, h, e, u = "Close",
        ...
        x = function (t, e, n, i) {
            ...
            return r.className = "mfp-" + t, n && (r.innerHTML = n), i ? e && e.appendChild(r) : (r = c(r), e && r.appendTo(e)), r
        },
        w = function (t, e) {
    ...
    t.prototype = {
        ...
        init: function () {
            ...
            f.isLowIE = f.isIE8 = document.all && !document.addEventListener, f.isAndroid = /android/gi.test(t), f.isIOS = /iphone|ipad|ipod/gi.test(t), f.supportsTransition = function () {
                ...
                return !1
            }(), f.probablyMobile = f.isAndroid || f.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), d = c(document), f.popupsCache = {}
        },
        open: function (t) {
            var e;
            if (!1 === t.isObj) {
            ...
            if (!f.isOpen) {
                f.types = [], h = "", t.mainEl && t.mainEl.length ? f.ev = t.mainEl.eq(0) : f.ev = d, t.key ? (f.popupsCache[t.key] || (f.popupsCache[t.key] = {}), f.currTemplate = f.popupsCache[t.key]) : f.currTemplate = {}, f.st = c.extend(!0, {}, c.magnificPopup.defaults, t), f.fixedContentPos = "auto" === f.st.fixedContentPos ? !f.probablyMobile : f.st.fixedContentPos, f.st.modal && (f.st.closeOnContentClick = !1, f.st.closeOnBgClick = !1, f.st.showCloseBtn = !1, f.st.enableEscapeKey = !1), f.bgOverlay || (f.bgOverlay = x("bg").on("click" + g, function () {
                    f.close()
                }), f.wrap = x("wrap").attr("tabindex", -1).on("click" + g, function (t) {
                ...
                w("BeforeOpen"), f.st.showCloseBtn && (f.st.closeBtnInside ? (b(p, function (t, e, n, i) {
                    n.close_replaceWith = C(i.type)
                }), h += " mfp-close-btn-in") : f.wrap.append(C())), f.st.alignTop && (h += " mfp-align-top"), f.fixedContentPos ? f.wrap.css({
                    ...
                    height: d.height(),
                    position: "absolute"
                }), f.st.enableEscapeKey && d.on("keyup" + g, function (t) {
                ...
                return f.isIE7 && (l += " mfp-ie7"), l && f._addClassToMFP(l), f.updateItemHTML(), w("BuildControls"), c("html").css(a), f.bgOverlay.add(f.wrap).prependTo(f.st.prependTo || c(document.body)), f._lastFocusedEl = document.activeElement, setTimeout(function () {
                    f.content ? (f._addClassToMFP(v), f._setFocus()) : f.bgOverlay.addClass(v), d.on("focusin" + g, f._onFocusIn)
                }, 16), f.isOpen = !0, f.updateSize(s), w(m), t
            }
            f.updateItemHTML()
        },
        close: function () {
            f.isOpen && (w(l), f.isOpen = !1, f.st.removalDelay && !f.isLowIE && f.supportsTransition ? (f._addClassToMFP(n), setTimeout(function () {
                f._close()
        ...
        _close: function () {
            ...
            if (f.bgOverlay.detach(), f.wrap.detach(), f.container.empty(), f.st.mainClass && (t += f.st.mainClass + " "), f._removeClassFromMFP(t), f.fixedContentPos) {
                ...
                f.isIE7 ? c("body, html").css("overflow", "") : e.overflow = "", c("html").css(e)
            }
        ...
        updateItemHTML: function () {
            ...
            var e = t.type;
            if (w("BeforeChange", [f.currItem ? f.currItem.type : "", e]), f.currItem = t, !f.currTemplate[e]) {
            ...
            f.appendContent(i, e), t.preloaded = !0, w("Change", t), r = t.type, f.container.prepend(f.contentContainer), w("AfterChange")
        },
        appendContent: function (t, e) {
            (f.content = t) ? f.st.showCloseBtn && f.st.closeBtnInside && !0 === f.currTemplate[e] ? f.content.find(".mfp-close").length || f.content.append(C()) : f.content = t: f.content = "", w("BeforeAppend"), f.container.addClass("mfp-" + e + "-holder"), f.contentContainer.append(f.content)
        },
        parseEl: function (t) {
            var e, n = f.items[t];
            if ((n = n.tagName ? {
            ...
            return n.type = e || f.st.type || "inline", n.index = t, n.parsed = !0, f.items[t] = n, w("ElementParse", n), f.items[t]
        },
        ...
        _openClick: function (t, e, n) {
            if ((void 0 !== n.midClick ? n.midClick : c.magnificPopup.defaults.midClick) || !(2 === t.which || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey)) {
                ...
                t.type && (t.preventDefault(), f.isOpen && t.stopPropagation()), n.el = c(t.mfpEl), n.delegate && (n.items = e.find(n.delegate)), f.open(n)
            }
        },
        updateStatus: function (t, e) {
            if (f.preloader) {
                i !== t && f.container.removeClass("mfp-s-" + i), e || "loading" !== t || (e = f.st.tLoading);
                var n = {
                    status: t,
                    text: e
                };
                w("UpdateStatus", n), t = n.status, e = n.text, f.preloader.html(e), f.preloader.find("a").on("click", function (t) {
                    t.stopImmediatePropagation()
                }), f.container.addClass("mfp-s-" + t), i = t
            }
        },
        ...
        _hasScrollBar: function (t) {
            return (f.isIE7 ? d.height() : document.body.scrollHeight) > (t || y.height())
        },
        _setFocus: function () {
        ...
        _parseMarkup: function (r, t, e) {
            var o;
            e.data && (t = c.extend(e.data, t)), w(p, [r, t, e]), c.each(t, function (t, e) {
                if (void 0 === e || !1 === e) return !0;
                if (1 < (o = t.split("_")).length) {
                    var n = r.find(g + "-" + o[0]);
                    if (0 < n.length) {
                        var i = o[1];
                        "replaceWith" === i ? n[0] !== e[0] && n.replaceWith(e) : "img" === i ? n.is("img") ? n.attr("src", e) : n.replaceWith(c("<img>").attr("src", e).attr("class", n.attr("class"))) : n.attr(o[1], e)
                    }
        ...
        if ("string" == typeof t)
            if ("open" === t) {
                var n, i = a ? e.data("magnificPopup") : e[0].magnificPopup,
                    r = parseInt(arguments[1], 10) || 0;
                n = i.items ? i.items[r] : (n = e, i.delegate && (n = n.find(i.delegate)), n.eq(r)), f._openClick({
                    mfpEl: n
                }, e, i)
            } else f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1));
        else t = c.extend(!0, {}, t), a ? e.data("magnificPopup", t) : e[0].magnificPopup = t, f.addGroup(e, t);
        return e
    };
    var E, T, S, k = "inline",
        _ = function () {
            ...
            getInline: function (t, e) {
                if (_(), t.src) {
                    ...
                    if (i.length) {
                        ...
                        r && r.tagName && (T || (E = n.hiddenClass, T = x(E), E = "mfp-" + E), S = i.after(T).detach().removeClass(E)), f.updateStatus("ready")
    ...
    c.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function () {
                f.types.push(A), O = f.st.ajax.cursor, b(u + "." + A, j), b("BeforeChange." + A, j)
            },
            getAjax: function (r) {
                ...
                var t = c.extend({
                    ...
                    success: function (t, e, n) {
                        ...
                        w("ParseAjax", i), f.appendContent(c(i.data), A), r.finished = !0, L(), f._setFocus(), setTimeout(function () {
                            f.wrap.addClass(v)
                        }, 16), f.updateStatus("ready"), w("AjaxContentAdded")
                    },
                    error: function () {
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function () {
                var t = f.st.image,
                    e = ".image";
                f.types.push("image"), b(m + e, function () {
                ...
                }), b("Resize" + e, f.resizeImage), f.isLowIE && b("AfterChange", f.resizeImage)
            },
            ...
            _onImageHasSize: function (t) {
                t.img && (t.hasSize = !0, I && clearInterval(I), t.isCheckingImgSize = !1, w("ImageHasSize", t), t.imgHidden && (f.content && f.content.removeClass("mfp-loading"), t.imgHidden = !1))
            },
                ...
                var n = 0,
                    ...
                    r = function (t) {
                        I && clearInterval(I), I = setInterval(function () {
                            0 < i.naturalWidth ? f._onImageHasSize(e) : (200 < n && clearInterval(I), 3 === ++n ? r(10) : 40 === n ? r(50) : 100 === n && r(500))
                        }, t)
                    };
                r(1)
            },
            getImage: function (t, e) {
                var n = 0,
                    i = function () {
                        t && (t.img[0].complete ? (t.img.off(".mfploader"), t === f.currItem && (f._onImageHasSize(t), f.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, w("ImageLoadComplete")) : ++n < 200 ? setTimeout(i, 100) : r())
                    },
                    r = function () {
                        t && (t.img.off(".mfploader"), t === f.currItem && (f._onImageHasSize(t), f.updateStatus("error", o.tError.replace("%url%", t.src))), t.hasSize = !0, t.loaded = !0, t.loadError = !0)
                    },
                    o = f.st.image,
                    s = e.find(".mfp-img");
                if (s.length) {
                    var a = document.createElement("img");
                    a.className = "mfp-img", t.el && t.el.find("img").length && (a.alt = t.el.find("img").attr("alt")), t.img = c(a).on("load.mfploader", i).on("error.mfploader", r), a.src = t.src, s.is("img") && (t.img = t.img.clone()), 0 < (a = t.img[0]).naturalWidth ? t.hasSize = !0 : a.width || (t.hasSize = !1)
                }
                ...
                }, t), f.resizeImage(), t.hasSize ? (I && clearInterval(I), t.loadError ? (e.addClass("mfp-loading"), f.updateStatus("error", o.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), f.updateStatus("ready"))) : (f.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), f.findImageSize(t))), e
            }
        }
    });
    var N;
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function () {
                ...
                if (o.enabled && f.supportsTransition) {
                    ...
                    b("BuildControls" + e, function () {
                        if (f._allowZoom()) {
                            if (clearTimeout(n), f.content.css("visibility", "hidden"), !(t = f._getItemToZoom())) return void a();
                            (i = s(t)).css(f._getOffset()), f.wrap.append(i), n = setTimeout(function () {
            ...
            _getOffset: function (t) {
                var e, n = (e = t ? f.currItem.img : f.st.zoom.opener(f.currItem.el || f.currItem)).offset(),
    ...
    c.magnificPopup.registerModule(M, {
        ...
        proto: {
            initIframe: function () {
                f.types.push(M), b("BeforeChange", function (t, e, n) {
                    e !== n && (e === M ? D() : n === M && D(!0))
                }), b(u + "." + M, function () {
                    D()
                })
            ...
            getIframe: function (t, e) {
                ...
                var r = {};
                return i.srcAction && (r[i.srcAction] = n), f._parseMarkup(e, r, t), f.updateStatus("ready"), e
            }
        }
    });
    var z = function (t) {
    ...
    c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function () {
                ...
                h += " mfp-gallery", b(m + t, function () {
                    ...
                    if (1 < f.items.length && o.arrows && !f.arrowLeft) {
                        var t = o.arrowMarkup,
                            e = f.arrowLeft = c(t.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")).addClass(s),
                            n = f.arrowRight = c(t.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")).addClass(s);
                        e.click(function () {
                            f.prev()
                        }), n.click(function () {
                            f.next()
                    ...
                    d.off(t), f.wrap.off("click" + t), f.arrowRight = f.arrowLeft = null
                })
            },
            next: function () {
            ...
            preloadNearbyImages: function () {
                ...
                for (t = 1; t <= (f.direction ? i : n); t++) f._preloadItem(f.index + t);
                for (t = 1; t <= (f.direction ? n : i); t++) f._preloadItem(f.index - t)
            },
            _preloadItem: function (t) {
                if (t = z(t), !f.items[t].preloaded) {
                    var e = f.items[t];
                    e.parsed || (e = f.parseEl(t)), w("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function () {
                        e.hasSize = !0
        ...
        proto: {
            initRetina: function () {
                if (1 < window.devicePixelRatio) {
                    var n = f.st.retina,
                        i = n.ratio;
                    1 < (i = isNaN(i) ? i() : i) && (b("ImageHasSize." + q, function (t, e) {
                        e.img.css({
...
function (e, n) {
    ...
    function i(l, r, c) {
        (c = c || e || t.jQuery) && (r.prototype.option || (r.prototype.option = function (t) {
            ...
            var e, o, s, a, u, i, n = f.call(arguments, 1);
            return s = n, u = "$()." + l + '("' + (o = t) + '")', (e = this).each(function (t, e) {
                var n = c.data(e, l);
                if (n) {
                    var i = n[o];
                    if (i && "_" != o.charAt(0)) {
...
function (t, e) {
    ...
    function E(t) {
        if (function () {
            ...
            for (var i = n.isBorderBox = "border-box" == e.boxSizing, r = 0; r < b; r++) {
                var o = y[r],
                    s = e[o],
                    a = parseFloat(s);
                n[o] = isNaN(a) ? 0 : a
...
function (n, i) {
    "function" == typeof define && define.amd ? define("outlayer/item", ["ev-emitter/ev-emitter", "get-size/get-size"], function (t, e) {
        return i(n, t, e)
    }) : "object" == typeof module && module.exports ? module.exports = i(n, require("ev-emitter"), require("get-size")) : (n.Outlayer = {}, n.Outlayer.Item = i(n, n.EvEmitter, n.getSize))
    ...
    }, l.transition = u.prototype[r ? "_transition" : "_nonTransition"], l.onwebkitTransitionEnd = function (t) {
...
function (r, o) {
    ...
    function c(t, e) {
        ...
        if (n) {
            ...
            var i = ++u;
            this.element.outlayerGUID = i, (l[i] = this)._create(), this._getOption("initLayout") && this.layout()
    ...
    return o.extend(f, e.prototype), f.option = function (t) {
        ...
        this[t] = i ? ("string" == typeof i ? n = this.element.querySelector(i) : i instanceof HTMLElement && (n = i), n ? r(n)[e] : i) : 0
    ...
    }, f._getContainerSize = n, f._setContainerMeasure = function (t, e) {
        if (void 0 !== t) {
            var n = this.size;
    ...
    }, f._manageStamp = n, f._getElementOffset = function (t) {
        ...
        this.resize()
    }, o.debounceMethod(c, "onresize", 100), f.resize = function () {
        ...
        delete l[e], delete this.element.outlayerGUID, a && a.removeData(this.element, this.constructor.namespace)
    }, c.data = function (t) {
...
function (t, e) {
    ...
    return e.compatOptions.fitWidth = "isFitWidth", e.prototype._resetLayout = function () {
        ...
        for (var i = this._getColGroup(n), r = Math.min.apply(Math, i), o = i.indexOf(r), s = {
                ...
                y: r
            }, a = r + t.size.outerHeight, u = this.cols + 1 - i.length, l = 0; l < u; l++) this.colYs[o + l] = a;
        return s
        ...
        for (var a = (this._getOption("originTop") ? n.top : n.bottom) + e.outerHeight, u = o; u <= s; u++) this.colYs[u] = Math.max(a, this.colYs[u])
            ...
            u = function (n) {
                ...
                l(i.filtersGroupSelector).children().each(function () {
                    l(this).on("click", function () {
                        l(i.filtersGroupSelector).children().removeClass("selected"), window.location.hash = l(this).data("filter");
                        var t = [];
                        t.push("." + l(this).data("filter")), l(this).addClass("selected");
                        var e = r;
                        0 < t.length && (e = s(t)), a(n, e)
                    })
                }), t = n, e = window.location.hash.replace("#", ""), -1 !== l.inArray(e, o) && a(t, l("." + e)), l(i.filtersGroupSelector).children().removeClass("selected"), l(".filters li[data-filter=" + window.location.hash.replace("#", "") + "]").addClass("selected")
            };
        return this.each(function () {
            var t, n, e = l(this);
            (t = e).find(i.itemSelector).each(function () {
                r.push(l(this))
            }), t.masonry(i), "list" === i.selectorType ? u(e) : (n = e, l(i.filtersGroupSelector).find("input[type=radio]").each(function () {
                l(this).change(function () {
                    var t = [];
                    l(i.filtersGroupSelector).find("input[type=radio]").each(function () {
    ...
    return function (n) {
        ...
        var m = n(1),
            ...
            x = function (t, e, n) {
                ...
                for (i in u && (n = e), n) o = ((r = !a && d && void 0 !== d[i]) ? d : n)[i], s = f && r ? b(o, m) : c && "function" == typeof o ? b(Function.call, o) : o, d && y(d, i, o, t & x.U), h[i] != o && v(h, i, s), c && p[i] != o && (p[i] = o)
            };
        ...
        n(3).inspectSource = function (t) {
            ...
            r && (a(n, "name") || s(n, "name", e)), t[e] !== n && (r && (a(n, u) || s(n, u, t[e] ? "" + t[e] : l.join(String(e)))), t === o ? t[e] = n : i ? t[e] ? t[e] = n : s(t, e, n) : (delete t[e], s(t, e, n)))
        ...
        var r = function () {
            function r(t, e) {
                ...
                })(this, r), this.el = t, this.flashTimeout, this.contentEl, this.scrollContentEl, this.dragOffset = {
                    x: 0,
                    y: 0
                }, this.isVisible = {
                    x: !0,
            ...
            return t = r, n = [{
                    ...
                    this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this), "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(function (t) {
                        t.forEach(function (t) {
                            Array.from(t.addedNodes).forEach(function (t) {
                                1 === t.nodeType && (t.hasAttribute("data-simplebar") ? !t.SimpleBar && new r(t, r.getElOptions(t)) : Array.from(t.querySelectorAll("[data-simplebar]")).forEach(function (t) {
                ...
                value: function (i) {
                    return Object.keys(r.htmlAttributes).reduce(function (t, e) {
                        ...
                        return i.hasAttribute(n) && (t[e] = JSON.parse(i.getAttribute(n) || !0)), t
                    }, {})
                }
            }, {
                key: "removeObserver",
                ...
                value: function (t) {
                    var e, n, i;
                    t.preventDefault(), i = "y" === this.currentAxis ? (e = t.pageY, n = this.trackY, this.scrollContentEl) : (e = t.pageX, n = this.trackX, this.contentEl);
                    var r = (e - n.getBoundingClientRect()[this.offsetAttr[this.currentAxis]] - this.dragOffset[this.currentAxis]) / n[this.sizeAttr[this.currentAxis]] * this.contentEl[this.scrollSizeAttr[this.currentAxis]];
                ...
                key: "resizeScrollbar",
                value: function () {
                    var t, e, n, i, r, o = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "y",
                        s = (r = "x" === o ? (t = this.trackX, e = this.scrollbarX, n = this.contentEl[this.scrollOffsetAttr[o]], i = this.contentSizeX, this.scrollbarXSize) : (t = this.trackY, e = this.scrollbarY, n = this.scrollContentEl[this.scrollOffsetAttr[o]], i = this.contentSizeY, this.scrollbarYSize)) / i,
                        a = n / (i - r),
                        u = Math.max(~~(s * r), this.options.scrollbarMinSize),
                        l = ~~((r - u) * a);
                    this.isVisible[o] = r < i, this.isVisible[o] || this.options.forceVisible ? (t.style.visibility = "visible", this.options.forceVisible ? e.style.visibility = "hidden" : e.style.visibility = "visible", "x" === o ? (e.style.left = "".concat(l, "px"), e.style.width = "".concat(u, "px")) : (e.style.top = "".concat(l, "px"), e.style.height = "".concat(u, "px"))) : t.style.visibility = "hidden"
                }
            }, {
                key: "onScrollX",
                value: function () {
        ...
        t.exports = function (t, e, n, i, r, o, s) {
            ...
            if (y && (l = _(y.call(new t))) !== Object.prototype && l.next && (k(l, f, !0), b || E(l, O) || C(l, O, L)), d && m && "values" !== m.name && (h = !0, g = function () {
                    return m.call(this)
                }), b && !s || !A && !h && p[O] || C(p, O, g), T[e] = g, T[f] = L, r)
                if (a = {
                        values: d ? g : c("values"),
                        keys: o ? g : c("keys"),
                        entries: v
        ...
        var r = i(6),
            ...
            l = function () {
                var t, e = i(17)("iframe"),
                    n = s.length;
                for (e.style.display = "none", i(44).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), l = t.F; n--;) delete l.prototype[s[n]];
                return l()
            };
        t.exports = Object.create || function (t, e) {
            var n;
            return null !== t ? (u.prototype = r(t), n = new u, u.prototype = null, n[a] = t) : n = l(), void 0 === e ? n : o(n, e)
        }
    }, function (t, e, n) {
        var s = n(5),
            a = n(6),
        ...
        i(i.S + i.F * !n(52)(function (t) {
            ...
            from: function (t) {
                var e, n, i, r, o = h(t),
                    ...
                    c = 0,
                    f = y(o);
                if (l && (u = d(u, 2 < a ? arguments[2] : void 0, 2)), null == f || s == Array && m(f))
                    for (n = new s(e = g(o.length)); c < e; c++) v(n, c, l ? u(o[c], c) : o[c]);
                else
                    for (r = f.call(o), n = new s; !(i = r.next()).done; c++) v(n, c, l ? p(r, u, [i.value, c], !0) : i.value);
                return n.length = c, n
            }
        })
    }, function (t, e, n) {
        ...
        (function (t) {
            ...
            function b(t) {
                ...
                if ("symbol" == typeof (e = t) || (n = e) && "object" == typeof n && d.call(e) == s) return o;
                var e, n;
                if (y(t)) {
                ...
                t = t.replace(a, "");
                var r = l.test(t);
                return r || c.test(t) ? f(t.slice(2), r ? 2 : 8) : u.test(t) ? o : +t
            }
            var o = NaN,
                s = "[object Symbol]",
                a = /^\s+|\s+$/g,
            ...
            r.exports = function (i, r, t) {
                ...
                function a() {
                    var t, e, n = C();
                    if (s(n)) return u(n);
                    h = setTimeout(a, (e = r - ((t = n) - p), v ? w(e, f - (t - m)) : e))
                }
                ...
                function e() {
                    ...
                    if (l = arguments, c = this, p = e, n) {
                        if (void 0 === h) return m = t = p, h = setTimeout(a, r), g ? o(t) : d;
                ...
                return r = b(r) || 0, y(t) && (g = !!t.leading, f = (v = "maxWait" in t) ? x(b(t.maxWait) || 0, r) : f, n = "trailing" in t ? !!t.trailing : n), e.cancel = function () {
        ...
        function i(t) {
            ...
            var i = getComputedStyle(t),
                ...
                a = f(i.width),
                u = f(i.height);
            if ("border-box" === i.boxSizing && (Math.round(a + o) !== e && (a -= d(i, "left", "right") + o), Math.round(u + s) !== n && (u -= d(i, "top", "bottom") + s)), t !== document.documentElement) {
        ...
        function r(t) {
            return s ? v(t) ? h(0, 0, (e = t.getBBox()).width, e.height) : i(t) : g;
            var e
        }
        ...
        var o = function () {
            ...
            u = "function" == typeof requestAnimationFrame ? requestAnimationFrame : function (t) {
                return setTimeout(function () {
                    return t(Date.now())
                }, 1e3 / 60)
            },
            a = ["top", "right", "bottom", "left", "width", "height", "size", "weight"],
            l = "undefined" != typeof navigator && /Trident\/.*rv:11/.test(navigator.userAgent),
        ...
        p.prototype.addObserver = function (t) {
            ...
            s && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), c ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
                attributes: !0,
                childList: !0,
                characterData: !0,
                subtree: !0
        ...
        var m = function (t, e) {
            ...
            g = h(0, 0, 0, 0),
            v = "undefined" != typeof SVGGraphicsElement ? function (t) {
                return t instanceof SVGGraphicsElement
            } : function (t) {
                return t instanceof SVGElement && "function" == typeof t.getBBox
            },
            y = function (t) {
                this.broadcastWidth = 0, this.broadcastHeight = 0, this.contentRect_ = h(0, 0, 0, 0), this.target = t
            };
        ...
        var b = function (t, e) {
                var n, i, r, o, s, a, u, l = (i = (n = e).x, r = n.y, o = n.width, s = n.height, a = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, u = Object.create(a.prototype), m(u, {
                    x: i,
                    y: r,
                    width: o,
                    height: s,
            ...
            x = function (t, e, n) {
                ...
                this.activeObservations_ = [], this.observations_ = new o, this.callback_ = t, this.controller_ = e, this.callbackCtx_ = n
            };
        ...
        t.exports = function () {
            ...
            for (var n, i, r = function (t) {
                ...
                if (u) {
                    i = u(n);
                    for (var a = 0; a < i.length; a++) c.call(n, i[a]) && (r[i[a]] = n[i[a]])
                }
            }
            return r
        }
...
function (r) {
    ...
    o.prototype = {
        ...
        build: function () {
            var n = this;
            if (!0 === this.showCursor && (this.cursor = r('<span class="typed-cursor">' + this.cursorChar + "</span>"), this.el.after(this.cursor)), this.stringsElement) {
        ...
        typewrite: function (o, s) {
            if (!0 !== this.stop) {
                ...
                a.timeout = setTimeout(function () {
                    ...
                    if ("^" === e.charAt(0)) {
                        var n = 1;
                        /^\^\d+/.test(e) && (n += (e = /\d+/.exec(e)[0]).length, t = parseInt(e)), o = o.substring(0, s) + o.substring(s + n)
                    }
                    if ("html" === a.contentType) {
                        var i = o.substr(s).charAt(0);
                        if ("<" === i || "&" === i) {
                            var r = "";
                            for (r = "<" === i ? ">" : ";"; o.substr(s).charAt(0) !== r;) o.substr(s).charAt(0), s++;
                            s++, r
                        }
                    }
                    a.timeout = setTimeout(function () {
                        if (s === o.length) {
                            ...
                            a.attr ? a.el.attr(a.attr, t) : a.isInput ? a.el.val(t) : "html" === a.contentType ? a.el.html(t) : a.el.text(t), s++, a.typewrite(o, s)
                        }
                    }, t)
                }, t)
            }
            ...
            if (!0 !== this.stop) {
                ...
                i.timeout = setTimeout(function () {
                    if ("html" === i.contentType && ">" === e.substr(n).charAt(0)) {
                        for (;
                            "<" !== e.substr(n).charAt(0);) e.substr(n).charAt(0), n--;
                        n--, "<"
                    }
                    var t = e.substr(0, n);
                    i.attr ? i.el.attr(i.attr, t) : i.isInput ? i.el.val(t) : "html" === i.contentType ? i.el.html(t) : i.el.text(t), n > i.stopNum ? (n--, i.backspace(e, n)) : n <= i.stopNum && (i.arrayPos++, i.arrayPos === i.strings.length ? (i.arrayPos = 0, i.shuffle && (i.sequence = i.shuffleArray(i.sequence)), i.init()) : i.typewrite(i.strings[i.sequence[i.arrayPos]], n))
                }, t)
            }
        },
        ...
        return this.each(function () {
            var t = r(this),
                e = t.data("typed"),
                n = "object" == typeof i && i;
            e || t.data("typed", e = new o(this, n)), "string" == typeof i && e[i]()
        })
    }, r.fn.typed.defaults = {
    ...
    if ($(".typed-title").typed({
        ...
        }), $("#video-bg").length) $("#video-bg").YTPlayer();
    $("#home-card").length && $(".top-menu").on("click", "a", function () {
        var t = $(".lines-grid"),
            e = $(this).attr("href"),
            n = $(".card-inner"),
            i = $(e),
            r = $(".top-menu li"),
            o = $(this).closest("li");
        return !o.hasClass("active") & $("#home-card").length && (r.removeClass("active"), t.removeClass("loaded"), o.addClass("active"), setTimeout(function () {
            t.addClass("loaded"), $(n).removeClass("active"), $(i).addClass("active")
        }, 1e3)), !1
        ...
        return $("head").append('<link rel="stylesheet" href="css/theme-colors/' + t + '.css" />'), !1
    });
    var n = $(".grid-items");
    n.imagesLoaded(function () {
        ...
        success: "valid",
        submitHandler: function () {}
    }), $("#map").length && initMap(), $(".blogs-content").height() > $(".blogs-sidebar").height() && 1023 < t && $(".blogs-sidebar").css({
        "min-height": $(".blogs-content").height()
    }), $(".blogs-content").height() < $(".blogs-sidebar").height() && 1023 < t && $(".blogs-content").css({
        "min-height": $(".blogs-sidebar").height()
    }), $(window).resize(function () {
        var t = $(window).width();
        $(".blogs-content").height() > $(".blogs-sidebar").height() && 1023 < t && $(".blogs-sidebar").css({
            "min-height": $(".blogs-content").height()
        }), $(".blogs-content").height() < $(".blogs-sidebar").height() && 1023 < t && $(".blogs-content").css({
            "min-height": $(".blogs-sidebar").height()
        })
    }), $(".top-menu").on("click", "a", function () {
        return $("#home-card").length || (location.href = "/patrick/" + $(this).attr("href")), !1
    });
    var i = location.hash,
        r = $(i);
    0 == i.indexOf("#") && -1 != i.indexOf("-card") && r.length && ($(".top-menu li").removeClass("active"), $('.top-menu a[href="' + i + '"]').parent().addClass("active"), $(".lines-grid").removeClass("loaded"), $(".card-inner").removeClass("active"), $(i).addClass("active"))
});
