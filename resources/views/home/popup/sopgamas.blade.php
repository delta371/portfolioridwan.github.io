<div id="popup-sopgamas" class="popup-box mfp-fade mfp-hide">
	<div class="content">
		<div class="image">
			<div class="slideshow-container">

                <div class="sopGamasSlide4 fade">
                <div class="numbertext">1 / 1</div>
                <img src="{{asset('project/sopgamas/sopgamas.png')}}" style="width:100%">
...
function showSlides4(n) {
  var i;
  var slides = document.getElementsByClassName("sopGamasSlide4");
